...
internal static class CliRuntime
{
    ...
    public static async Task<global::Gladia.GladiaClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
    ...
    private static async Task WriteApiExceptionAsync(global::Gladia.ApiException exception)
    {
        var builder = new StringBuilder();
