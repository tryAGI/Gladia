...
namespace Gladia
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Gladia.AutoSDKRetryOptions Retry { get; set; } = new global::Gladia.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Gladia.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Gladia.IAutoSDKHook>();
        ...
        public global::Gladia.AutoSDKClientOptions AddHook(
            global::Gladia.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Gladia.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Gladia.AutoSDKClientOptions UseAuthorizationProvider(
            global::Gladia.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Gladia.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Gladia.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Gladia.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Gladia.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Gladia.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Gladia.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Gladia.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Gladia.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Gladia.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Gladia.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Gladia.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Gladia.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Gladia.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Gladia.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Gladia.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Gladia.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Gladia.AutoSDKClientOptions clientOptions,
            global::Gladia.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Gladia.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Gladia.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Gladia.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Gladia.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Gladia.IAutoSDKHook, global::Gladia.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Gladia.AutoSDKHookContext context)
        {
