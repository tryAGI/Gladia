...
namespace Gladia.CLI;

internal static class CliRuntime
{
    private const string UserSecretsId = "Gladia.CLI";
    private const string UserSecretApiKeyName = "GLADIA_API_KEY";
    private static readonly string[] ApiKeyEnvironmentVariables = [@"GLADIA_API_KEY"];
    private const string CredentialFileDirectoryName = ".gladia";

    public static async global::System.Threading.Tasks.Task<global::Gladia.GladiaClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
        ...
        var authorizations = string.IsNullOrWhiteSpace(apiKey)
            ? new global::System.Collections.Generic.List<global::Gladia.EndPointAuthorization>()
            : new global::System.Collections.Generic.List<global::Gladia.EndPointAuthorization>
            {
        CreateAuthorization(
            type: "Http",
        ...
        return new global::Gladia.GladiaClient(
            httpClient: null,
            baseUri: baseUri,
    ...
    private static global::Gladia.EndPointAuthorization CreateAuthorization(
        string type,
        string schemeId,
        string location,
        string name,
        string value)
    {
        var authorization = new global::Gladia.EndPointAuthorization
        {
            Type = type,
            Location = location,
            Name = name,
        ...
        var schemeIdProperty = typeof(global::Gladia.EndPointAuthorization).GetProperty("SchemeId");
    ...
    public static async global::System.Threading.Tasks.Task<int> RunAsync(Func<global::System.Threading.Tasks.Task> action, CancellationToken cancellationToken = default)
    {
        ...
        catch (global::Gladia.ApiException exception)
        {
    ...
    private static Uri? ResolveBaseUri(ParseResult parseResult)
    {
        ...
        {
            baseUrl = Environment.GetEnvironmentVariable("GLADIA_BASE_URL");
        }
    ...
    private static async global::System.Threading.Tasks.Task WriteApiExceptionAsync(global::Gladia.ApiException exception)
    {
        var builder = new StringBuilder();
