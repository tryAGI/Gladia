    ...
    public static Command Create()
    {
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                        ...
                        var video = CliRuntime.WasSpecified(parseResult, Video) ? parseResult.GetValue(Video) : __requestBase is not null ? __requestBase.Video : default;
                        var videoname = CliRuntime.WasSpecified(parseResult, Videoname) ? parseResult.GetValue(Videoname) : __requestBase is not null ? __requestBase.Videoname : default;
                        var videoUrl = CliRuntime.WasSpecified(parseResult, VideoUrl) ? parseResult.GetValue(VideoUrl) : __requestBase is not null ? __requestBase.VideoUrl : default;
