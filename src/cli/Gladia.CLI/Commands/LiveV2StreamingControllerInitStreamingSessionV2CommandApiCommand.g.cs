    ...
    public static Command Create()
    {
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                        ...
                        var bitDepth = CliRuntime.WasSpecified(parseResult, BitDepth) ? parseResult.GetValue(BitDepth) : (__requestBase is { } __BitDepthBaseValue ? __BitDepthBaseValue.BitDepth : default);
                        ...
                        var channels = CliRuntime.WasSpecified(parseResult, Channels) ? parseResult.GetValue(Channels) : (__requestBase is { } __ChannelsBaseValue ? __ChannelsBaseValue.Channels : default);
                        var customMetadata = CliRuntime.WasSpecified(parseResult, CustomMetadata) ? parseResult.GetValue(CustomMetadata) : (__requestBase is { } __CustomMetadataBaseValue ? __CustomMetadataBaseValue.CustomMetadata : default);
                        ...
                        var endpointing = CliRuntime.WasSpecified(parseResult, Endpointing) ? parseResult.GetValue(Endpointing) : (__requestBase is { } __EndpointingBaseValue ? __EndpointingBaseValue.Endpointing : default);
                        var maximumDurationWithoutEndpointing = CliRuntime.WasSpecified(parseResult, MaximumDurationWithoutEndpointing) ? parseResult.GetValue(MaximumDurationWithoutEndpointing) : (__requestBase is { } __MaximumDurationWithoutEndpointingBaseValue ? __MaximumDurationWithoutEndpointingBaseValue.MaximumDurationWithoutEndpointing : default);
                        ...
                        var realtimeProcessing = CliRuntime.WasSpecified(parseResult, RealtimeProcessing) ? parseResult.GetValue(RealtimeProcessing) : (__requestBase is { } __RealtimeProcessingBaseValue ? __RealtimeProcessingBaseValue.RealtimeProcessing : default);
                        ...
                        var messagesConfig = CliRuntime.WasSpecified(parseResult, MessagesConfig) ? parseResult.GetValue(MessagesConfig) : (__requestBase is { } __MessagesConfigBaseValue ? __MessagesConfigBaseValue.MessagesConfig : default);
