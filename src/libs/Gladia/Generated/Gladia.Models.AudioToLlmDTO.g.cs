...
namespace Gladia
{
    ...
    public sealed partial class AudioToLlmDTO
    {
        ...
        public global::Gladia.AudioToLlmResultDTO? Results { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AudioToLlmDTO" /> class.
        /// </summary>
        /// <param name="success">
        /// The audio intelligence model succeeded to get a valid output
        /// </param>
...
#endif
        public AudioToLlmDTO(
            bool success,
            bool isEmpty,
            double execTime,
            global::Gladia.AddonErrorDTO? error,
            global::Gladia.AudioToLlmResultDTO? results)
        {
