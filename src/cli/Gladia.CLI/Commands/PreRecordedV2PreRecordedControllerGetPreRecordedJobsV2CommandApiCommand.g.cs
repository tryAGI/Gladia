...
internal static partial class PreRecordedV2PreRecordedControllerGetPreRecordedJobsV2CommandApiCommand
{
    ...
    private static Option<global::System.Collections.Generic.IList<global::Gladia.PreRecordedControllerGetPreRecordedJobsV2Statu>?> Status { get; } = new(
        name: @"--status")
    {
        ...
        name: @"--custom-metadata")
    {
        Description = @"",
                    ...
                    private static string FormatResponse(ParseResult parseResult, global::Gladia.ListPreRecordedResponse value, global::System.Text.Json.Serialization.JsonSerializerContext context, bool truncateLongStrings)
                    {
                        string? text = null;
                    ...
                    static partial void CustomizeResponseText(ParseResult parseResult, global::Gladia.ListPreRecordedResponse value, ref string? text);
