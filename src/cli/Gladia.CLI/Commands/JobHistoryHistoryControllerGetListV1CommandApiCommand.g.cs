...
internal static partial class JobHistoryHistoryControllerGetListV1CommandApiCommand
{
    ...
    private static Option<global::System.Collections.Generic.IList<global::Gladia.HistoryControllerGetListV1Statu>?> Status { get; } = new(
        name: @"--status")
    {
    ...
    private static Option<global::System.Collections.Generic.IList<global::Gladia.HistoryControllerGetListV1KindItem>?> Kind { get; } = new(
        name: @"--kind")
    {
        Description = @"Filter the list based on the item type. Supports multiple values from the predefined list.",
    };

                    private static string FormatResponse(ParseResult parseResult, global::Gladia.ListHistoryResponse value, global::System.Text.Json.Serialization.JsonSerializerContext context, bool truncateLongStrings)
                    {
                        string? text = null;
                    ...
                    static partial void CustomizeResponseText(ParseResult parseResult, global::Gladia.ListHistoryResponse value, ref string? text);
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.JobHistory.HistoryControllerGetListV1Async(
                                    offset: offset,
                                    limit: limit,
                                    date: date,
