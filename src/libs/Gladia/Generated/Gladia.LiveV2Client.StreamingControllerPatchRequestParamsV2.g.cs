...
namespace Gladia
{
    public partial class LiveV2Client
    {
        ...
        private static readonly global::Gladia.EndPointSecurityRequirement s_StreamingControllerPatchRequestParamsV2SecurityRequirement0 =
        ...
        private static readonly global::Gladia.EndPointSecurityRequirement[] s_StreamingControllerPatchRequestParamsV2SecurityRequirements =
            new global::Gladia.EndPointSecurityRequirement[]
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Gladia.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Gladia.AutoSDKHttpResponse> StreamingControllerPatchRequestParamsV2AsResponseAsync(
            string id,
                ...
                else
                {
                    await global::Gladia.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 413)
                            {
                                ...
                                global::Gladia.PayloadTooLargeErrorResponse? __value_413 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_413 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_413 = global::Gladia.PayloadTooLargeErrorResponse.FromJson(__content_413, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_413 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Gladia.ApiException<global::Gladia.PayloadTooLargeErrorResponse>.Create(
                                    statusCode: __response.StatusCode,
