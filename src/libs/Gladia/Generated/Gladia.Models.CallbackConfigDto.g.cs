...
namespace Gladia
{
    ...
    public sealed partial class CallbackConfigDto
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Gladia.JsonConverters.CallbackMethodEnumJsonConverter))]
        public global::Gladia.CallbackMethodEnum? Method { get; set; }
        ...
        public CallbackConfigDto(
            string url,
            global::Gladia.CallbackMethodEnum? method)
        {
