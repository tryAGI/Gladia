...
namespace Gladia
{
    ...
    public sealed partial class ListPreRecordedResponse
    {
        ...
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::System.Collections.Generic.IList<global::Gladia.PreRecordedResponse> Items { get; set; }
        ...
        public ListPreRecordedResponse(
            string first,
            string current,
            global::System.Collections.Generic.IList<global::Gladia.PreRecordedResponse> items,
            string? next)
        {
