...
namespace Gladia
{
    public partial interface ILiveV2Client
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Gladia.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Gladia.AutoSDKHttpResponse<global::Gladia.StreamingResponse>> StreamingControllerGetStreamingJobV2AsResponseAsync(
            string id,
            global::Gladia.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);
    }
