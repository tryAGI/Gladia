...
namespace Gladia
{
    public partial interface ILiveV2Client
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Gladia.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Gladia.AutoSDKHttpResponse<global::Gladia.ListStreamingResponse>> StreamingControllerGetStreamingJobsV2AsResponseAsync(
            int? offset = default,
            int? limit = default,
            global::System.DateTime? date = default,
            global::System.DateTime? beforeDate = default,
